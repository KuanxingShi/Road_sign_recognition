...
#                         print track_box
                        imageX = track_box[0][0]  #中心坐标X
                        imageY = track_box[0][1]  #中心坐标Y
                        imageR = (track_box[1][0] + track_box[1][1]) /4 ##长短轴平均值
                        ...
                        visResizeHSV = cv2.cvtColor(visResize, cv2.COLOR_BGR2HSV)
